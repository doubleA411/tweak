...
export default function FAQPage() {
  return (
    <div className=" flex flex-col justify-center items-center mx-32">
      <p className="mt-10 text-3xl font-extrabold mb-10">FAQ</p>
      <Accordion type="single" collapsible className=" w-[500px]">
        <AccordionItem value="item-1">
          <AccordionTrigger>How to download and install?</AccordionTrigger>
          <AccordionContent>
            The download button in the home page will redirct you to the download link.
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="item-4">
          <AccordionTrigger>Do we have to sign up or anything ?</AccordionTrigger>
          <AccordionContent>
